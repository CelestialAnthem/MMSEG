_base_ = [
    '../_base_/default_runtime.py', '../_base_/datasets/mapillary_v2.py'
]
# crop_size = (896, 896)
crop_size = (672, 672)
...
# query_embeding, level embeding to decay_multi=0.0
...
default_hooks = dict(
    ...
    checkpoint=dict(
        type='CheckpointHook', by_epoch=False, interval=12000, save_best='mIoU', max_keep_ckpts=1),
...
work_dir = './work_dirs/dinov2_mapillaryv2_vitg'
